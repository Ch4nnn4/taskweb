  ...
  return `
    <div class="task-card ${claseCard}">
      ...
      <div class="task-actions">
        ${!t.completada ? `<button class="btn btn-success" onclick="toggleComplete(${t.id}, 1)">✓</button>` : `<button class="btn" style="background:#888;padding:6px 12px;font-size:12px;width:auto;border-radius:6px" onclick="toggleComplete(${t.id}, 0)">↩</button>`}
